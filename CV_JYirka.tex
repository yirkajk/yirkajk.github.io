...
J. Yirka. Even quantum advice is unlikely to solve \textup{PP}. Available at \url{https://arxiv.org/abs/2403.09994}. Also at \url{https://eccc.weizmann.ac.il/report/2024/052/}. March 2024.

J. Kallaugher, O. Parekh, K. Thompson, Y. Wang, and J. Yirka. Complexity Classification of Product State Problems for Local Hamiltonians. Available at \url{https://arxiv.org/abs/2401.06725}. January 2024.
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}[itemsep=\pubItemSep]
		\item \textbf{Contributed talk by J. Yirka} at 27th Conference on Quantum Information Processing (QIP). Taiwan, January 2024.
	\end{itemize}
\end{adjustwidth}
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}[itemsep=\pubItemSep]
		\item \textbf{Poster by J. Yirka} at 27th Conference on Quantum Information Processing (QIP). Taiwan, January 2024.
	\end{itemize}
\end{adjustwidth}
