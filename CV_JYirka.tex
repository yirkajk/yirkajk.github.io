...
{	
	\begin{adjustwidth}{.25in}{}
		...
		\textbf{Topic:} Automated conjecturing and graph Hamiltonicity. Implement algorithms for graph properties, improve open-source project structure for future use, and evaluate conjectures for graph Hamiltonicity.
	\end{adjustwidth}
}
