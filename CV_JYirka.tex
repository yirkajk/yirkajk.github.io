...
\begin{center}
	...
	\includegraphics[height=1.2\fontcharht\font`X]{logos/arxiv-bw.jpg}
	...
	\faYoutube{}
	\href{https://www.youtube.com/@JustinYirka/playlists}{youtube.com/@JustinYirka/playlists}
\end{center}
...
\qquad Complexity theory, Hamiltonian complexity, Quantum algorithms
...
\cventry{August 2025--Present}{\textbf{Quantum Computing Researcher} | \href{https://blanqet.net/}{Blanqet}}{}{}{}
{
	\begin{adjustwidth}{.25in}{}
		Researcher (employee \#2) at a UChicago-affiliated startup with industry pioneers (e.g. Scott Aaronson, David Awschalom, Bill Fefferman, Liang Jiang, and more).  \newline
		Pursuing real-world applications of quantum computing and quantum communication.
	\end{adjustwidth}
}
...
\cventry{June 2023--May 2025}{\textbf{R\&D Intern} | Sandia National Laboratories}{}{}{}
{
	\begin{adjustwidth}{.25in}{}
		...
		Topic: Hardness of computing product state solutions to Hamiltonian optimization problems. Quantum Max-Cut and Vector Max-Cut.
		Novel variant of Grover's (fault-tolerant) search algorithm in alternative query models.
	\end{adjustwidth}
}
...
\cventry{Summer 2019}{\textbf{Summer School Fellow} | Los Alamos National Laboratories}{}{}{}
{
	\begin{adjustwidth}{.25in}{}
		...
		Topic: Near-term (NISQ) quantum algorithms.
		Designed low-width algorithms for entanglement spectroscopy with error mitigation using mid-circuit measurements and qubit resets.
		Validated algorithms with noisy simulations in Qiskit and experiments on Honeywell (Quantinuum) ion-trap device.
	\end{adjustwidth}
}
...
\cventry{Summer 2017}{\textbf{Undergraduate Researcher} (REU) | QuICS, University of Maryland}
{}{}{}
{
	\begin{adjustwidth}{.25in}{}
...
\cventry{March 2015--Aug 2016}{\textbf{Research Assistant} | Quantum Computing Lab, VCU}{}{}{}
{
	\begin{adjustwidth}{.25in}{}
		...
		Topic: Complexity theory. Studied Hamiltonian complexity and quantum oracle classes  (e.g. {\scriptsize $\textup{P}^{\textup{QMA[log]}}$}). Helped develop a ``quantum PH'' and ``quantum Toda's Theorem'' ({\scriptsize $\textup{QCPH}\subseteq \textup{P}^{\textup{PP}^{\textup{PP}}}$}).
	\end{adjustwidth}
}
...
{\footnotesize
	...
	Links to recordings, slides, etc.\ available at \href{https://www.justinyirka.com/}{justinyirka.com}.
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}
		\item[--] \href{https://doi.org/10.26153/tsw/61157}{doi:10.26153/tsw/61157},\quad 2025.
	\end{itemize}
\end{adjustwidth}
\medskip
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}
		\item In Proceedings of \textit{20th Conference on the Theory of Quantum Computation, Communication, and Cryptography (TQC)}, Bengaluru, India,  2025.\quad
		\href{https://doi.org/10.4230/LIPIcs.TQC.2025.1}{doi:10.4230/LIPIcs.TQC.2025.1}.
		\item[--] \href{https://arxiv.org/abs/2504.03620}{arXiv:2504.03620},\quad
		2025.
	\end{itemize}
\end{adjustwidth}
\medskip
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}
		\item[--] \href{https://arxiv.org/abs/2503.02747}{arXiv:2503.02747},\quad
		2025.
	\end{itemize}
\end{adjustwidth}
\medskip
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}
		...
		\item[--] \href{https://arxiv.org/abs/2403.09994}{arXiv:2403.09994} and \href{https://eccc.weizmann.ac.il/report/2024/052/}{ECCC:TR24-052},\quad
		2024.
	\end{itemize}
\end{adjustwidth}
\medskip
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}
		...
		\item[--] \href{https://arxiv.org/abs/2401.01453}{arXiv:2401.01453} and \href{https://eccc.weizmann.ac.il/report/2024/006/}{ECCC:TR24-006},\quad
		2024.
	\end{itemize}
\end{adjustwidth}
\medskip
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}
		...
		\item[--] \href{https://arxiv.org/abs/2401.06725}{arXiv:2401.06725},\quad
		2024.
	\end{itemize}
\end{adjustwidth}
\medskip
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}
		...
		\item[--] \href{https://arxiv.org/abs/2010.03080}{arXiv:2010.03080},\quad 2020.
	\end{itemize}
\end{adjustwidth}
\medskip
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}
		...
		\item[--]  \href{https://arxiv.org/abs/1909.05981}{arXiv:1909.05981},\quad 2019.
	\end{itemize}
\end{adjustwidth}
\medskip
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}
		...
		\item[--] \href{https://arxiv.org/abs/1805.11139}{arXiv:1805.11139},\quad 2018.
	\end{itemize}
\end{adjustwidth}
\medskip
...
\begin{adjustwidth}{.25in}{}
	\begin{itemize}[itemsep=\pubItemSep]
		...
		\item[--] \href{https://arxiv.org/abs/1606.05626}{arXiv:1606.05626},\quad 2016.
	\end{itemize}
\end{adjustwidth}
...
\begin{itemize}
	\item[\textbullet] Quantum Algorithms for Finance Workshop at IEEE Quantum Week (QCE). Albuquerque, USA, 2025.

	\item[\textbullet] All-hands meeting. Quantum Systems Accelerator, a DOE QIS Research Center. Albuquerque, USA, 2024.

	\item[\textbullet] Workshop | Quantum Complexity: Theory and Application. Simons Institute for the Theory of Computing. Berkeley, USA, March 2024.

	\item[\textbullet] Invited Workshop | Quantum Complexity: Theory and Application. Schloss Dagstuhl. Virtual, June 2021.

	\item[\textbullet] Visiting Researcher | Collaboration with Sevag Gharibian. University of Paderborn, Germany. November 2018.\newline
	Topic: $\textup{QMA}_{1}$-hardness of the quantum satisfaction problem ($k$-QSAT) on qudits of lower dimensions.
\end{itemize}

%%==========  Other  =======================================================
%\smallskip
%\subsection{Other Conferences Attended}
...
\smallskip
Additional talks and panels listed under \textbf{Volunteering} below.
...
{
\begin{adjustwidth}{.25in}{}
	Co-Organized with Shivan Mittal. Invited speakers: Chinmay Nirkhe (Prof. at Univ. of Washington), Dorian Rudolph (University of Paderborn, Germany), Jackson Morris (UCSD)
\end{adjustwidth}
}
...
\cvitem{Conference subreviewer}{STACS 2026, STOC 2025, QIP (2025, 2024, 2022), TQC (2023, 2022), ITCS 2023, RANDOM 2023, CCC 2022}
...
\newpage
\cventry{Spring 2016, Spring 2017}{\textbf{Lead Reader} | VCU Honors College graduation dossiers}{}{}{}
{
	\begin{adjustwidth}{.25in}{}
...
\begin{itemize}
	\item[\textbullet] \textbf{Talk}: My career from VCU and an introduction to quantum computing. \quad VCU Linux User Group, Virtual, 2025.
