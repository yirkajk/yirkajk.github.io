...
\usepackage[margin=.56in]{geometry}
...
\subsection{Projects}
\cventry{2018--present}{Web design --- hosted on Github; designed using Markdown.}
{\href{https://github.com/yirkajk/yirkajk.github.io}{www.JustinYirka.com --- Personal website}}
{}{}
{}

\cventry{Summer 2018}{Python}
{\href{https://github.com/math1um/objects-invariants-properties}{\textit{Graph Brains Project} --- Graph Theory Computational Discovery Lab, VCU}}
{}{}
{
	\begin{adjustwidth}{.25in}{}
...
{
	\begin{adjustwidth}{.25in}{}
		Team project with focus on Agile development. Implemented Android app for sharing geocached photos.
	\end{adjustwidth}
}
